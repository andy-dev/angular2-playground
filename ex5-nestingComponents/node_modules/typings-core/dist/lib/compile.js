...
function compile(tree, options) {
    ...
    return Promise.all([
        compileDependencyTree(tree, extend(options, { browser: false, readFiles: readFiles, imported: {} })),
        compileDependencyTree(tree, extend(options, { browser: true, readFiles: readFiles, imported: {} }))
    ])
        .then(function (_a) {
